...
### 🔥 LEVIR-CD 变化检测 SOTA | F1: **90.85%** | IoU: **83.24%**

<br>

| 🏆 **排行榜** | 📊 **测试指标** | ⚡ **特性** |
|:---:|:---:|:---:|
| **LEVIR-CD F1 第一** | **90.85%** F1 / **83.24%** IoU | ConvNeXt + 交叉注意力 |
| 📦 **提供权重文件** | **91.89%** 精确率 / **89.84%** 召回率 | 8x TTA / 混合精度 |
| 🐍 **开箱即用** | ⏱ **150 轮** ~ 6h (P100) | Kaggle 就绪笔记本 |
...
> **TransConvNeXt-CD** 是一个 Transformer-CNN 混合架构的遥感**变化检测**模型。在 LEVIR-CD 基准上达到 **90.85% F1** 和 **83.24% IoU**，显著超越此前的方法。
...
TransConvNeXt-CD 在 LEVIR-CD 基准上达到**最先进水平**：
...
> 相比此前最佳方法 (BIT)，F1 提升 **+1.54%**，IoU 提升 **+2.56%**。
